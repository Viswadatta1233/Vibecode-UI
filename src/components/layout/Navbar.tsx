...
import { Code, LogOut, User, Sun, Moon, ChevronDown, Settings, BookOpen } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white dark:bg-leetcode-gray-800 shadow-sm border-b border-leetcode-gray-200 dark:border-leetcode-gray-700 transition-colors duration-200 w-full">
      <div className="flex justify-between h-16 w-full px-4 md:px-8">
        <div className="flex items-center">
          <Link to="/" className="flex items-center space-x-2">
            <Code className="h-8 w-8 text-leetcode-green" />
            <span className="text-xl font-bold text-leetcode-gray-900 dark:text-white">VibeCode</span>
          </Link>
        </div>
